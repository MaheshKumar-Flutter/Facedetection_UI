...
class ExpansionTileController {
  ...
  _ExpansionAnimateTileState? _state;
  ...
  static ExpansionTileController of(BuildContext context) {
    final _ExpansionAnimateTileState? result = context.findAncestorStateOfType<_ExpansionAnimateTileState>();
    if (result != null) {
  ...
  static ExpansionTileController? maybeOf(BuildContext context) {
    return context.findAncestorStateOfType<_ExpansionAnimateTileState>()?._tileController;
  }
}
...
class ExpansionAnimateTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const ExpansionAnimateTile({
    super.key,
    this.leading,
    required this.title,
    this.subtitle,
    ...
    this.controller, this.customDecoration, this.linearGraient, this.requiredColor, this.coloredBox, this.headerPadding, this.minLeadingWidth,
  }) : assert(
  ...
  @override
  State<ExpansionAnimateTile> createState() => _ExpansionAnimateTileState();
}

class _ExpansionAnimateTileState extends State<ExpansionAnimateTile> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant ExpansionAnimateTile oldWidget) {
